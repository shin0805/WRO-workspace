	...
	switch (counter) {
		case 0:
			if (counter5 == 0){
				...
				ev3_motor_set_power(EV3_PORT_D, 30);
				do{
				}while(ev3_motor_get_counts(EV3_PORT_A) >= -130 * a);//125//135//140
		...
		case 1:
			...
			ev3_motor_set_power(EV3_PORT_D, 30);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -60 * a);//25
		...
		case 3:
			...
			if (counter5 == 0){
				...
				power = slow;
				do{
				}while((ev3_motor_get_counts(EV3_PORT_A) * -1 + ev3_motor_get_counts(EV3_PORT_D)) / 2 >= -315 * a);
				ev3_stp_cyc(TRACE);
			}
			counter5 = 0;
			...
			case 1:
				...
				if(container[1] == 1 || container[1] == 2) {
					...
					if(yes_container[3] == 0){
						...
						ev3_motor_reset_counts(EV3_PORT_A);
						do{
						}while(ev3_motor_get_counts(EV3_PORT_A) <= 410 * a);//100//500
