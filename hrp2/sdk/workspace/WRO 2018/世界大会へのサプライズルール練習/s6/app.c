...
void main_task(intptr_t unused) {
  ...
  gain_rate = two_fast;
	...
	*pHT = 0;
	do{
		ev3_sta_cyc(HT4);
		if((*pHT == 1 || *pHT == 7 || *pHT == 8 || *pHT == 9 || *pHT == 10) && no_color == 1 && twice == 0) {
			ev3_speaker_play_tone(1975.53, 200);
			i = 0;
			twice = 1;
		}else if((*pHT == 4 || *pHT == 13) && no_color == 2 && twice == 0) {
			ev3_speaker_play_tone(1396.91, 200);
			i = 1;
			twice = 1;
		}else if((*pHT == 5 || *pHT == 6) && no_color == 3 && twice == 0) {
			ev3_speaker_play_tone(880.00, 200);
			i = 2;
			twice = 1;
		}else if((*pHT == 2 || *pHT == 11 || *pHT == 3) && no_color == 4 && twice == 0) {
			ev3_speaker_play_tone(261.63, 200);
			i = 3;
			twice = 1;
		}else{
