...
void scan_task(intptr_t unused) {
	...
	if(counter == 3){
		do{
			if((*pHT == 1 || *pHT == 7 || *pHT == 8) && yes_container[counter] == 0) {
				yes_container[counter] = 1;
				ev3_speaker_play_tone(1975.53, 200);
				if(no_color != 1){
					container[counter] = 1;
				}
			}else if((*pHT == 4 || *pHT == 13) && yes_container[counter] == 0) {
				yes_container[counter] = 2;
				ev3_speaker_play_tone(1396.91, 200);
				if(no_color != 2){
					container[counter] = 2;
				}
			}else if((*pHT == 5 || *pHT == 6) && yes_container[counter] == 0) {
				yes_container[counter] = 3;
				ev3_speaker_play_tone(880.00, 200);
				if(no_color != 3){
					container[counter] = 3;
				}
			}else if((*pHT == 2 || *pHT == 11) && yes_container[counter] == 0) {
		...
		do{
			if((*pHT == 1 || *pHT == 7 || *pHT == 10) && yes_container[counter] == 0) {
				yes_container[counter] = 1;
				ev3_speaker_play_tone(1975.53, 200);
				if(no_color != 1){
					container[counter] = 1;
			...
			}else if(*pHT == 5 && yes_container[counter] == 0) {
				yes_container[counter] = 3;
				ev3_speaker_play_tone(880.00, 200);
				if(no_color != 3){
					container[counter] = 3;
...
void main_task(intptr_t unused) {
	...
	while(1){
		...
		ev3_motor_rotate(EV3_PORT_B, 370, 80, true);
	...
	*pHT = 0;
	...
	}while((ev3_motor_get_counts(EV3_PORT_A) + ev3_motor_get_counts(EV3_PORT_D) * -1) / 2 <= 10 * a);
	...
	do{
		...
		*pHT = 0;
		...
		if (ship[container[counter_a] - 1] == ship[i]) {
			...
			power = slow;
			counter6 = 1;
			counter_d = ship[container[counter_a] - 1];
