...
void main_task(intptr_t unused) {
	...
	if(container[0] != 0) {
		...
		if(container[0] == 3 || container[0] == 4) {
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 550 * a);//150
			...
			ev3_motor_rotate(EV3_PORT_A, 165 * a, 20, true);
			...
			ev3_motor_rotate(EV3_PORT_D, -150 * a, 20, true);
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 350 * a);//150
			...
			ev3_motor_reset_counts(EV3_PORT_D);
			do{
			}while((ev3_motor_get_counts(EV3_PORT_A) * -1 + ev3_motor_get_counts(EV3_PORT_D)) / 2 >= -0 * a);//550
		...
		if(container[3] == 3 || container[3] == 4) {
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 800 * a);
		...
		switch (counter_c) {
			...
			case 1:
				...
				if(container[1] == 1 || container[1] == 2) {
					//container[1]が赤、緑の場合
					if(yes_container[3] == 10){//ここにはいれさせない
						ev3_motor_reset_counts(EV3_PORT_A);
						ev3_motor_set_power(EV3_PORT_A, slow * -1);
						ev3_motor_set_power(EV3_PORT_D, slow);
						do{
