...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_rotate(EV3_PORT_C, -265, 30, false);//190
	...
	if(h_rgb > 100){
		...
		do{
		}while(ev3_motor_get_counts(EV3_PORT_C) * -1 <= 190);//120
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1450);
