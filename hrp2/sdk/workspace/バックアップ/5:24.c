...
void main_task(intptr_t unused) {
	...
	if(container[0] != 0) {
		...
		if(container[0] == 3 || container[0] == 4) {
			...
			ev3_motor_rotate(EV3_PORT_B, -200, 80, false);
			...
			ev3_motor_rotate(EV3_PORT_B, 330, 100, false);
			...
			ev3_motor_rotate(EV3_PORT_B, 330, 80, false);
		...
		if(container[3] == 3 || container[3] == 4) {
			...
			//軸に乗せる
			ev3_motor_rotate(EV3_PORT_A, -60, slow * -1, false);
			ev3_motor_rotate(EV3_PORT_D, -60, slow * -1, true);
