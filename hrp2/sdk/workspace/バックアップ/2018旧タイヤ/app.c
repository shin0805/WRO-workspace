...
void change_yb_task(intptr_t unused) {
	...
	ev3_motor_rotate(EV3_PORT_A, -180, 20, false);
	ev3_motor_rotate(EV3_PORT_D, -180, 20, true);
...
void change_rg_task(intptr_t unused) {
	...
	ev3_motor_set_power(EV3_PORT_D, 30);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) <= 200);
...
void ship_left_task(intptr_t unused) {
	...
	//方向転換
	ev3_motor_rotate(EV3_PORT_A, 165, 30, false);
	ev3_motor_rotate(EV3_PORT_D, -165, 30, true);
	...
	angle = 60 + (ship[container[counter] - 1] - 1) * 266;
...
void ship_right_task(intptr_t unused) {
	...
	angle = 60 + (6 - ship[container[counter] - 1]) * 266;
...
void catch_task(intptr_t unused) {
	...
	if(counter == 0 || counter == 2) {
		...
		ev3_motor_set_power(EV3_PORT_A, -30);
		ev3_motor_set_power(EV3_PORT_D, -30);
	}while(ev3_motor_get_counts(EV3_PORT_A) >= -250);
	...
	ev3_motor_rotate(EV3_PORT_B, -200, 80, true);
...
void main_task(intptr_t unused) {
	...
	ev3_sta_cyc(TRACE2);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) >= -220);
	...
	ev3_motor_reset_counts(EV3_PORT_A);
	ev3_motor_set_power(EV3_PORT_A, -40);
	ev3_motor_set_power(EV3_PORT_D, 13);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) >= -150);
	...
	if(container[0] != 0) {
		...
		if(container[0] == 3 || container[0] == 4) {
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -700);
			...
			ev3_motor_set_power(EV3_PORT_D, slow);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -138);

			ev3_sta_cyc(TRACE22);

			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -280);
			...
			ev3_motor_reset_counts(EV3_PORT_D);
			ev3_motor_set_power(EV3_PORT_A, 13);
			ev3_motor_set_power(EV3_PORT_D, -40);
			do{
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -380);
			...
			ev3_motor_set_power(EV3_PORT_D, -30);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_D) >= -90);
		...
		if(container[3] == 3 || container[3] == 4) {
			...
			ev3_motor_set_power(EV3_PORT_D, fast);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -690);
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -400);
			...
			ev3_motor_reset_counts(EV3_PORT_A);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -350);
	...
	for (i = 1; i <= 5; i++) {
		...
		*pHT = 0;
		...
		if (ship[container[counter_a] - 1] == i) {
			...
			ev3_motor_rotate(EV3_PORT_A, 40, 30, false);
			...
			//方向転換
			ev3_motor_rotate(EV3_PORT_A, 350, 30, true);
		...
		if (i == 2) {
			...
			ev3_sta_cyc(TRACE2);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= -124);
			ev3_stp_cyc(TRACE2);
		}
	...
	*pHT = 0;
	...
	}while(ev3_motor_get_counts(EV3_PORT_A) >= -80);
	...
	if (ship[container[counter_a] - 1] == 6) {
		...
		//下がる
		ev3_motor_rotate(EV3_PORT_A, 140, 30, false);
		ev3_motor_rotate(EV3_PORT_D, 140, 30, true);
		...
		//方向転換
		ev3_motor_rotate(EV3_PORT_A, 80, 30, false);
	...
	for (k = 0; k < 2 ; k++) {
		...
		if (k == 0) {
			...
			if (container[1] == 0) {
				...
				//壁合わせ and 方向転換　(左へ)
				ev3_motor_reset_counts(EV3_PORT_A);
				ev3_motor_set_power(EV3_PORT_A, fast * -1 - 10);
				ev3_motor_set_power(EV3_PORT_D, fast * -1);
				do{
				}while(ev3_motor_get_counts(EV3_PORT_A) <= 1250);
				...
				//少し下がる
				ev3_motor_rotate(EV3_PORT_A, -83, 30, false);
				ev3_motor_rotate(EV3_PORT_D, -83, 30, true);
		  	...
		  	counter_c = 1;
				...
				//下がる
				ev3_motor_rotate(EV3_PORT_A, 150, 30, false);
				ev3_motor_rotate(EV3_PORT_D, 150, 30, true);
				...
				//進む
				ev3_motor_rotate(EV3_PORT_A, -75, 30, false);
				ev3_motor_rotate(EV3_PORT_D, -75, 30, true);
			...
			if (counter_c == 1) {
				...
				if (counter_b == 1) {
					...
					if(1250 - angle >= 100) {
						...
						ev3_motor_set_power(EV3_PORT_D, fast);
						do{
						}while(ev3_motor_get_counts(EV3_PORT_A) >= (1250 - angle - 100) * -1);
					}
					ev3_motor_set_power(EV3_PORT_A, slow);
					ev3_motor_set_power(EV3_PORT_D, slow);
					do{
					}while(ev3_motor_get_counts(EV3_PORT_A) >= (1250 - angle) * -1);
					...
					//少し下がる
					ev3_motor_rotate(EV3_PORT_A, 104, 30, false);
					ev3_motor_rotate(EV3_PORT_D, 104, 30, true);
					...
					if(angle >= 100) {
						...
						ev3_motor_set_power(EV3_PORT_D, fast * -1);
						do{
						}while(ev3_motor_get_counts(EV3_PORT_A) <= (angle - 100));
					}
			...
			case 1:
				...
				if(container[1] == 1 || container[1] == 2) {
					...
					if(container[2] == 0){
						...
						ev3_motor_set_power(EV3_PORT_D, fast);
						do{
						}while(ev3_motor_get_counts(EV3_PORT_A) >= -415);

						ev3_motor_reset_counts(EV3_PORT_D);
						ev3_motor_set_power(EV3_PORT_A, 0);
						ev3_motor_set_power(EV3_PORT_D, fast);
						do{
						}while(ev3_motor_get_counts(EV3_PORT_D) >= -185);
	...
	if (counter_b == 1) {
		if (counter_d <= 3) {
			...
			if(1350 - angle >= 100) {
				...
				ev3_motor_set_power(EV3_PORT_D, fast);
				do{
				}while(ev3_motor_get_counts(EV3_PORT_A) >= (1350 - angle - 100) * -1);
			}
			ev3_motor_set_power(EV3_PORT_A, slow);
			ev3_motor_set_power(EV3_PORT_D, slow);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) >= (1350 - angle) * -1);
	...
	//ゴールエリアにinする
	ev3_motor_rotate(EV3_PORT_A, -300, slow * -1, false);
	ev3_motor_rotate(EV3_PORT_D, -300, slow * -1, true);
