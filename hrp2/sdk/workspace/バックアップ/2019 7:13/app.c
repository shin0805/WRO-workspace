...
void curve_task(intptr_t unused) {
	switch (curve) {
		...
		case 2://真ん中への左
			...
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 180);
...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_rotate(EV3_PORT_C, -260, 30, false);//190
	...
	*/
	...
	power = -15;
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 115);
	...
	if(h_rgb > 100){
		...
		do{
		}while(ev3_motor_get_counts(EV3_PORT_A) * -1 <= 320);
		ev3_motor_set_power(EV3_PORT_A, slow);
		do{
	...
	*/
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 400);//600
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 300);//295
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_B, -80);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 90);

	//ev3_motor_stop(EV3_PORT_B, true);

	ev3_motor_rotate(EV3_PORT_B, -820, 80, false);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1800);
