...
int black = 10;//20
int white = 45;//40
int threshold2 = 34;//35
int threshold3 = 29;//25
...
void ht4color_task(intptr_t unused) {
	...
	if(choice == 1){//赤
		...
		if(rgb4.g > 0 && rgb4.g <= 210){//r//170//230
			wup_tsk(MAIN_TASK);
		}
	}else if(choice == 3){//黄
		if(rgb4.b > 0 && rgb4.b <= 205){//170//230
			wup_tsk(MAIN_TASK);
		}
	}else if(choice == 4){//青
...
void drop_task(intptr_t unused) {
	if(direction == 1){
		...
		*/
		...
		//ev3_motor_set_power(EV3_PORT_C, 20);
		ev3_motor_rotate(EV3_PORT_C, 203, 20, false);//300
		...
		//ev3_motor_set_power(EV3_PORT_C, 20);
		ev3_motor_rotate(EV3_PORT_C, 308, 20, false);
		/*
		do{
		}while(ev3_motor_get_counts(EV3_PORT_C) <= 615);
		...
		*/
		...
		//ev3_motor_set_power(EV3_PORT_C, 20);
		ev3_motor_rotate(EV3_PORT_C, 203, 20, false);//300//200
		...
		//リンクをたたみきる
		ev3_motor_rotate(EV3_PORT_C, 278, 20, false);
		//ev3_motor_set_power(EV3_PORT_C, 20);
		/*
		do{
		}while(ev3_motor_get_counts(EV3_PORT_C) <= 615);
...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_D, -30);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 145);//125//150
