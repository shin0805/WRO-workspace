...
void main_task(intptr_t unused) {
	...
	if(container[0] != 0) {
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) + ev3_motor_get_counts(EV3_PORT_D)) / 2 >= -185 * a);
		ev3_stp_cyc(TRACE);
	...
	for (i = 1; i <= 5; i++) {
		...
		*pHT = 0;
		ev3_sta_cyc(HT4);
		do{
			if((*pHT == 7 || *pHT == 8 || *pHT == 9) && ship[0] == 0 && ship2[j] == 0) {
				ev3_speaker_play_tone(1975.53, 200);
				ship[0] = i;
				ship2[j] = 1;
				j += 1;
			}else if((*pHT == 4 || *pHT == 13) && ship[1] == 0 && ship2[j] == 0) {
				ev3_speaker_play_tone(1396.91, 200);
				ship[1] = i;
				ship2[j] = 2;
				j += 1;
			}else if((/**pHT == 5 ||*/ *pHT == 6) && ship[2] == 0 && ship2[j] == 0) {
				ev3_speaker_play_tone(880.00, 200);
				ship[2] = i;
				ship2[j] = 3;
				j += 1;
			}else if((*pHT == 2/* || *pHT == 3*/) && ship[3] == 0 && ship2[j] == 0) {
				ev3_speaker_play_tone(261.63, 200);
				ship[3] = i;
				ship2[j] = 4;
				j += 1;
			}else if(*pHT == 3 && ship[3] == 0 && ship2[j] == 0) {
				separate = 1;
			}else{
