...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_rotate(EV3_PORT_C, -190, 30, false);
	...
	*/
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 540);//600
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_A, slows * -1);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 300);//290
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 295);//285
	...
	*/
	...
	if(h_rgb > 100){
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 30);//185
