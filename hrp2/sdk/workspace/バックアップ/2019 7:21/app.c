...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 125);
	...
	if(h_rgb > 100){
		...
		ev3_motor_rotate(EV3_PORT_C, -60, 80, false);
	...
	*/
	...
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 997);//1000
	ev3_motor_stop(EV3_PORT_B, true);
	...
	*/
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 390);//600//400
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1900);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 95);//100
	...
	*/
	...
	if(h_rgb > 100 && device[1] != 0){
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 30);
