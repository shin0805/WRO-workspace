...
void drop_task(intptr_t unused) {
	...
	if(drop == 1){
		...
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 55);
		...
		ev3_motor_set_power(EV3_PORT_D, slow * -1);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 20);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		ev3_sta_cyc(STRAIGHT);
		//ev3_motor_set_power(EV3_PORT_A, -11);
		//ev3_motor_set_power(EV3_PORT_D, 10);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 85);
		ev3_stp_cyc(STRAIGHT);
...
void main_task(intptr_t unused) {
	...
	*/
	...
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 750);
	ev3_motor_stop(EV3_PORT_B, true);
	...
	*/
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 615);
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_B, -80);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 750);
	ev3_motor_stop(EV3_PORT_B, true);
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_B, 80);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 820);
	ev3_motor_stop(EV3_PORT_B, true);
	...
	ev3_motor_set_power(EV3_PORT_B, -80);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 820);
	ev3_motor_stop(EV3_PORT_B, true);
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_C);
	ev3_motor_set_power(EV3_PORT_C, 50);//25
	do{
	}while(ev3_motor_get_counts(EV3_PORT_C) <= 150);
	ev3_motor_stop(EV3_PORT_C, true);
