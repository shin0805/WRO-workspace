	...
	*/
	...
	switch (curve) {
		...
		case 7://真ん中への右 (両方黒から)
			...
			ev3_motor_set_power(EV3_PORT_D, -30);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 150);//170
		...
		case 8://真ん中への左 (両方黒から)
			...
			ev3_motor_set_power(EV3_PORT_D, 0);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 150);//170
...
void main_task(intptr_t unused) {
	...
	*/
	...
	do{
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 88);
		...
		*pHT = 0;
		...
		do{
			ev3_sta_cyc(HT1);
			if(*pHT == 1 || *pHT == 7 || *pHT == 8 || *pHT == 9 || *pHT == 10) {
				ev3_speaker_play_tone(1975.53, 200);
				identifier2[k] = 1;
				k += 1;
				twice = 1;
			}else if(*pHT == 4 /*|| *pHT == 13*/) {
				ev3_speaker_play_tone(1396.91, 200);
				identifier2[k] = 2;
				k += 1;
				twice = 1;
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1200);
	...
	//ev3_motor_reset_counts(EV3_PORT_B);
	//ev3_motor_rotate(EV3_PORT_B, 1200, 80, false);
	...
	if(identifier2[4] == 1 || identifier2[4] == 2){
		//右を向く(前)
		ev3_motor_stop(EV3_PORT_A, true);
		ev3_motor_reset_counts(EV3_PORT_D);
		ev3_motor_set_power(EV3_PORT_D, slow);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= (device[0] - 2) * -1 * 350);
		ev3_stp_cyc(FOWARD);
	}else{
		//左を向く
		ev3_motor_stop(EV3_PORT_D, true);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= device[0] * 350);
		ev3_stp_cyc(FOWARD);
	}
    ...
    ev3_motor_reset_counts(EV3_PORT_D);
    do{
    }while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 90);
		ev3_stp_cyc(BACK);
		...
		*/
		...
		if(identifier2[4] == 1){
			...
			ev3_motor_rotate(EV3_PORT_B, -1200, 80, false);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 1200);
			*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 650);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 400);
	...
	if(identifier2[5] == 1 || identifier2[5] == 2){
		//右を向く(前)
		ev3_motor_stop(EV3_PORT_A, true);
		ev3_motor_reset_counts(EV3_PORT_D);
		ev3_motor_set_power(EV3_PORT_D, slow);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= (device[1] - 2) * -1 * 300);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= anglegy);
		ev3_stp_cyc(FOWARD);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= device[1] * 300);
		...
		ev3_motor_set_power(EV3_PORT_D, -30);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 140);//125//150//145//140
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1300);
	...
	if(identifier2[5] == 1 || identifier2[5] == 2){
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 800);
	...
	ev3_sta_cyc(FOWARD);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 130);//175//170
