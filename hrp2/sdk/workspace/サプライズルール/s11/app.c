...
void main_task(intptr_t unused) {
	...
	*/
	...
	//アームを下ろす
	ev3_motor_reset_counts(EV3_PORT_B);
	ev3_motor_rotate(EV3_PORT_B, 750, 80, false);
	do{
	...
	ev3_motor_set_power(EV3_PORT_A, slow);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) * -1 <= 100);
	...
	//アームをあげる
	ev3_motor_reset_counts(EV3_PORT_B);
	ev3_motor_rotate(EV3_PORT_B, -500, 80, false);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 500);
	...
	ev3_motor_reset_counts(EV3_PORT_A);
	do{
		ev3_motor_set_power(EV3_PORT_A, 20);//pturn * -1);//30
		ev3_motor_set_power(EV3_PORT_D, 20);//pturn * -1);
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 300);

	do{
		ev3_motor_set_power(EV3_PORT_A, 20);//pturn * -1 - 10);//40
		ev3_motor_set_power(EV3_PORT_D, 20);//pturn * -1 - 10);
	}while(ev3_color_sensor_get_reflect(EV3_PORT_3) >= black);
  ...
  ev3_speaker_play_tone(1174.66, 200);
	...
	ev3_motor_rotate(EV3_PORT_B, 500, 80, false);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 500);
