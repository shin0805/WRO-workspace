...
void main_task(intptr_t unused) {
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1400);
	...
	ev3_motor_rotate(EV3_PORT_B, 1100, 80, false);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 1100);
	...
	//リンクをたたむ
	ev3_motor_rotate(EV3_PORT_C, 200, 20, false);
	ev3_motor_rotate(EV3_PORT_B, -1100, 80, false);
