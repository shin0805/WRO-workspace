...
//gainの変数
double two_fast = 2.04;//2.14
double two_slow = 0.85;//2.14//1.04
double one_fast = 3.0;//4.0
double one_slow = 1.5;//1.9//1.7
...
void right_task(intptr_t unused) {
	...
	do{
		ev3_motor_set_power(EV3_PORT_A, pturn * -1 + 10);
		ev3_motor_set_power(EV3_PORT_D, pturn * -1 + 10);
	}while(ev3_motor_get_counts(EV3_PORT_A) >= -50);//70
...
void curve_task(intptr_t unused) {
	switch (curve) {
		case 1://真ん中への右
			...
			do{
			}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 305);//140
		...
		case 2://真ん中への左
			...
			ev3_motor_set_power(EV3_PORT_D, 0);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 305);
		...
		case 7://真ん中への右 (両方黒から)
			...
			ev3_motor_set_power(EV3_PORT_D, -30);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 55);//85
		...
		case 8://真ん中への左 (両方黒から)
			...
			ev3_motor_set_power(EV3_PORT_D, 0);
			do{
			}while(ev3_motor_get_counts(EV3_PORT_A) <= 55);//85
...
void ht4white_task(intptr_t unused) {
	ht_nxt_color_sensor_measure_rgb(EV3_PORT_4, pRGB4);
...
void drop_task(intptr_t unused) {
	if(direction == 1){
		...
		*/
		...
		ev3_motor_rotate(EV3_PORT_C, 305, 20, false);//300
		...
		*/
		...
		ev3_sta_cyc(BACK);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 70);
		ev3_stp_cyc(BACK);
		...
		*/
		...
		ev3_motor_set_power(EV3_PORT_B, 50);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_B) <= 160);
		ev3_motor_stop(EV3_PORT_B, true);
		...
		*/
		...
		ev3_sta_cyc(BACK);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 105);
		ev3_stp_cyc(BACK);
		...
		ev3_sta_cyc(BACK);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 35);
		...
		*/
		...
		//下がりきる
		do{
		}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 80);
		ev3_stp_cyc(BACK);
...
void main_task(intptr_t unused) {
	...
	while(1){
		...
		do{
		}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 140);//150//190
		...
		ev3_motor_set_power(EV3_PORT_D, slows);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_A) <= 20);//25//40
		...
		ev3_motor_set_power(EV3_PORT_A, slows * -1);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_A) <= 190);//150//150
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_A, slows * -1);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 120);//155
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 15);//15
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 120);//155
	...
	ev3_motor_rotate(EV3_PORT_C, -180, 30, false);//190//265
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 100);//230
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 415);//600
	...
	ev3_motor_set_power(EV3_PORT_A, slows * -1);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 190);//290
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 190);//285
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 60);
	...
	power = -10;
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 145);
	...
	ev3_motor_set_power(EV3_PORT_B, -80);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) * -1 <= 200);//90

	//ev3_motor_stop(EV3_PORT_B, true);

	ev3_motor_rotate(EV3_PORT_B, -710, 80, false);//820
	...
	if(h_rgb > 100){
		...
		do{
		}while(ev3_motor_get_counts(EV3_PORT_A) * -1 <= 300);
		ev3_motor_set_power(EV3_PORT_A, slow);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_A) * -1 <= 355);
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 190);

		ev3_motor_reset_counts(EV3_PORT_C);
		ev3_motor_set_power(EV3_PORT_C, -100);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_C) * -1 <= 120);//120//190
		...
		ev3_motor_rotate(EV3_PORT_C, -50, 90, false);
		...
		*/
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 190);//250
		...
		ev3_motor_rotate(EV3_PORT_C, -50, 60, false);
		...
		power = -20;
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 195);//260
	...
	do{
	}while(ev3_motor_get_counts(EV3_PORT_B) <= 1000);
	ev3_motor_stop(EV3_PORT_B, true);

	//リンクをたたむ
	ev3_motor_rotate(EV3_PORT_C, 190, 20, false);
	...
	if(device[0] == 2){
		...
		*/
		...
		if(device[0] == 1){
			...
			ev3_sta_cyc(FOWARD);
			do{
			}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 105);
			ev3_stp_cyc(FOWARD);
		...
		ev3_motor_rotate(EV3_PORT_C, -50, 80, false);
	...
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 230);//600//300
	...
	ev3_motor_rotate(EV3_PORT_B, -710, 80, false);
	...
	if(device[1] == 0){
		...
		ev3_motor_set_power(EV3_PORT_D, fast * -1);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_D) <= 300);
		ev3_motor_set_power(EV3_PORT_D, slow * -1);
		do{
		}while(ev3_motor_get_counts(EV3_PORT_D) <= 355);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 80);//135
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 1050);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 70);
	...
	//ev3_motor_rotate(EV3_PORT_C, -50, 30, false);
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 225);
	...
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 300);
	ev3_motor_set_power(EV3_PORT_D, slow);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 355);
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 180);//250
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 100);//300
	...
	*/
	...
	ev3_motor_set_power(EV3_PORT_C, -30);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_C) * -1 <= 190);//180
	ev3_motor_stop(EV3_PORT_C, true);
	...
	*/
	...
	ev3_motor_reset_counts(EV3_PORT_D);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_D) - ev3_motor_get_counts(EV3_PORT_A)) / 2 <= 75);
	...
	*/
	...
	for (k = 0; k < 4; k++) {
		...
		ev3_motor_reset_counts(EV3_PORT_D);
		do{
		}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 95);
	...
	ev3_sta_cyc(FOWARD);
	do{
	}while((ev3_motor_get_counts(EV3_PORT_A) - ev3_motor_get_counts(EV3_PORT_D)) / 2 <= 130);//175
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_D) * -1 <= 130);
	...
	ev3_motor_set_power(EV3_PORT_D, slows);
	do{
	}while(ev3_motor_get_counts(EV3_PORT_A) <= 25);
	*/
